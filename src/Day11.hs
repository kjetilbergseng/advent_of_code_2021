...
updateElem :: Int -> Int -> Int -> (Matrix Int, Int) -> (Matrix Int, Int)
...
updateAllElems :: Int -> Int -> (Matrix Int, Int) -> (Matrix Int, Int)
...
runUntilAllZero :: Int -> Matrix Int -> Int
